...
//     String HTTP_POST_TALLYSAVE_URL="http://192.168.1.141:8080/Service/Slip/SaveTallyBill.aspx";
...
//    获取货位数据
    ...
    //    获取桩角和货位数据
    String HTTP_GetCornerPileAndAllocation_URL= "http://218.92.115.55/M_Lhgl/Service/Slip/GetSavedBoothAndAllocation.aspx";
