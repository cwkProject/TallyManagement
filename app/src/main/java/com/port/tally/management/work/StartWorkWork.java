 ...
 */
public class StartWorkWork extends DefaultWorkModel<String, StartWorkBean, StartWorkData> {
     ...
     */
    @Override
    protected StartWorkBean onRequestSuccessSetResult(StartWorkData data) {
     ...
     */
    @Override
    protected StartWorkData onCreateDataModel(String... parameters) {
        StartWorkData startWorkData = new StartWorkData();
