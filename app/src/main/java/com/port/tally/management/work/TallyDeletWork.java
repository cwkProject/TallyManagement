...
import com.port.tally.management.data.TallyDeletData;
 ...
 */
public class TallyDeletWork extends DefaultWorkModel<String, String, TallyDeletData> {
     ...
     */
    @Override
    protected String onRequestSuccessSetResult(TallyDeletData data) {
     ...
     */
    @Override
    protected String onRequestFailedSetResult(TallyDeletData data) {
        return data.getMessage();
    }
     ...
     */
    @Override
    protected TallyDeletData onCreateDataModel(String... parameters) {
