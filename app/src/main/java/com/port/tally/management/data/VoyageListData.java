 ...
 * @since 1.0
 */
public class VoyageListData extends JsonDataModel {
    ...
    protected void onRequestSuccess(JSONObject jsonResult) throws JSONException {
        ...
        if (jsonArray != null) {
            ...
            Log.i(LOG_TAG + "onRequestSuccess", "get voyageList count is " + jsonArray.length());
            ...
            Log.i(LOG_TAG + "onRequestSuccess", "voyage list count is " + voyageList.size());
        }
    }
}
